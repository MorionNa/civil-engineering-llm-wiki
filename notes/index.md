...
> 衍生笔记：PPT 汇报、讲座、视频、文章摘录 — 非论文深度分析的单页笔记。
...
- [[notes/articles/shenlan2026-physical-token-transolver]] — 从 CFD 到 Transolver：Dynamic Slicing、物理 Token 与 Physics Attention
